"""
Starter fabfile for deploying the onther project.
...
# CHANGEME
env.hosts = ['user@onther.example.com']
env.code_dir = '/srv/www/onther'
env.project_dir = '/srv/www/onther/onther'
env.static_root = '/srv/www/onther/static/'
env.virtualenv = '/srv/www/onther/.virtualenv'
env.code_repo = 'git@github.com:user/onther.git'
env.django_settings_module = 'onther.settings'
...
def restart():
    ...
    with cd(env.code_dir):
        run("touch %s/onther/wsgi.py" % env.code_dir)
