...
DEBUG_TOOLBAR_CONFIG = {
    ...
    'SHOW_TOOLBAR_CALLBACK': 'onther.settings.base.custom_show_toolbar',
...
WSGI_APPLICATION = 'onther.wsgi.application'
...
SYSTEM_EMAIL_PREFIX = "[onther]"

## Log settings

LOG_LEVEL = logging.INFO
HAS_SYSLOG = True
SYSLOG_TAG = "http_app_onther"  # Make this unique to your project.
